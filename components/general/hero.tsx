...
const Hero = () => {
    return (
        <>
            <section
                id="home"
                className="relative z-10 overflow-hidden dark:bg-neutral-900 bg-white pb-16 pt-30 dark:bg-gray-dark md:pb-30 md:pt-37.5 xl:pb-40 xl:pt-45 2xl:pb-50 2xl:pt-52.5"
            >
